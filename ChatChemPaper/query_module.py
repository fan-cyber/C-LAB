...
class QueryModule:
    ...
    def localize(self, root_summary, similarity_top_k=3, similarity_cutoff=0.7):
        ...
        docs = SimpleDirectoryReader(root_summary, recursive=True, exclude_hidden=True, file_metadata=filename_fn).load_data()
